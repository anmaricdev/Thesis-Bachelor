...
if args.wrap:
    print("Warning: The option -w, --wrap is deprecated. It is now the default behavior. Consult option -n, --nowrap to prevent wrapping the output inls a collapsible HTML element.")
